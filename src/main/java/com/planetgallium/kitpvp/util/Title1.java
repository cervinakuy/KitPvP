...
public class Title1 {
     ...
     */
    public Title1(String title, String subtitle) {
        this.title = title;
     ...
     */
    public Title1(String title, String subtitle, int fadeInTime, int stayTime,
                  int fadeOutTime) {
        this.title = title;
        this.subtitle = subtitle;
    ...
    public void updateTimes(Player player) {
        if (Title1.packetTitle != null) {
            try {
                Object handle = getHandle(player);
                Object connection = getField(handle.getClass(),
                        "playerConnection").get(handle);
                Object[] actions = Title1.packetActions.getEnumConstants();
                Method sendPacket = getMethod(connection.getClass(),
                        "sendPacket");
                Object packet = Title1.packetTitle.getConstructor(
                        new Class[]{Title1.packetActions, chatBaseComponent,
            ...
            try {
                ...
                Object serialized = nmsChatSerializer.getConstructor(
                        ...
                        .newInstance(
                                ChatColor.translateAlternateColorCodes('&',
                                        this.title));
                Object packet = Title1.packetTitle
                        .getConstructor(
                                new Class[]{Title1.packetActions,
