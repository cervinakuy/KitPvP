...
public class Title2 {
     ...
     */
    public Title2(String title, String subtitle) {
        this.title = title;
    ...
    public void updateTimes(Player player) {
        if (Title2.packetTitle != null) {
            try {
                Object handle = getHandle(player);
                Object connection = playerConnection.get(handle);
                Object[] actions = Title2.packetActions.getEnumConstants();
                Object packet = Title2.packetTitle.getConstructor(
                        new Class[]{Title2.packetActions, chatBaseComponent,
            ...
            try {
                ...
                Object serialized = nmsChatSerializer.getConstructor(
                        ...
                        .newInstance(titleColor +
                                ChatColor.translateAlternateColorCodes('&',
                                        this.title));
                Object packet = Title2.packetTitle
                        .getConstructor(
                                new Class[]{Title2.packetActions,
